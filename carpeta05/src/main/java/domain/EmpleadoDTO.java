...
public class EmpleadoDTO {
    ...
    public EmpleadoDTO(int idEmplado) {
        this.idEmplado = idEmplado;
    }
    
    
    //Insertar un nuevo registro en la BD con la primaru key en aumento, ID_Persona.
    public EmpleadoDTO(String primerNombre, String segundoNombre, String primerApellido, String fechaNacimiento, int id_Departamento) {
    ...
    public EmpleadoDTO(int idEmplado, String primerNombre, String segundoNombre, String primerApellido, String fechaNacimiento, int id_Departamento) {
        this.idEmplado = idEmplado; 
        this.primerNombre = primerNombre;
        this.segundoNombre = segundoNombre;
        this.primerApellido = primerApellido;
